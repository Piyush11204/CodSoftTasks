...
b1 = Button(frame1, text="Rock",
            font=10, width=15, bg="#54FF22",
            command=isrock)
 
b2 = Button(frame1, text="Paper ",
            font=10, width=15, bg="#FF2222",
            command=ispaper)
 
b3 = Button(frame1, text="Scissor",
            font=10, width=15, bg="#52FFE5",
            command=isscissor)
...
l3 = Label(frame, text="Computer", font="normal 20 bold")
l3 = Label(frame, text="Computer", font="normal 20 bold")
